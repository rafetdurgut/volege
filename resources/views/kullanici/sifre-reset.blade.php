          ...
          <div class="card disable-rounded-right d-flex justify-content-center mb-0 p-2 h-100">
            <div class="card-header pb-1">
              <div class="card-title">
                <h4 class="text-center mb-2">Şifrenizi sıfırlayalım.</h4>
              </div>
            </div>
            <div class="card-body">
              <form class="mb-2" method="POST" action="{{ route('password.update') }}">
                ...
                <div class="form-group">
                  <label class="text-bold-600" for="password">Yeni Şifreniz:</label>
                ...
                <div class="form-group mb-2">
                  <label class="text-bold-600" for="password-confirm">Yeni Şifreniz (Tekrar):</label>
