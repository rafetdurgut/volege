      ...
      <div class="form-group row">
        <div class="col-sm-6">
          <div class="form-group row">
            ...
            <div class="input-group col-sm-9">
              <input type="text" class="form-control" name="faturakodu" id="faturakodu" placeholder="" autocomplete="off"
                required>
              <input type="button" id="faturaKoduOlustur" name="faturaKoduOlustur" value="Oluştur"
          ...
          <div class="form-group row">
            ...
            <div class="input-group col-sm-9">
              <input type="datetime-local" class="form-control" name="faturatarihi"
                value="{{ Carbon\Carbon::now()->format('Y-m-d') . 'T' . Carbon\Carbon::now()->format('H:i') }}"
                id="faturatarihi" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="form-group row">
            <label for="vade" class="col-sm-3 col-form-label">Vadesi</label>
            <div class="input-group col-sm-9">
              <input type="datetime-local" id="vade" name="vade" class="form-control" placeholder="" aria-label="Username"
        ...
        <div class="col-sm-6">
          <div class="form-group row">
            ...
            <div class="input-group col-sm-9">
              <input type="text" class="form-control" id="tckimlik_ss" name="carikodu" placeholder="" required
                autocomplete="off">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="input-group col-sm-9">
              <input type="text" id="adsoyad_ss" name="cariadi" class="form-control" placeholder="" aria-label="Username"
                aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="form-group row">
        ...
        <div class="col-sm-12">
          ...
          <div data-repeater-list="parcalar" id="parcalar">
            <div data-repeater-item>
              <div class="form-group parca-satir row">
                <div class="col-sm-2">
                  <input type="text" name="stokno" class="form-control ypstoknotxt ui-autocomplete-input"
                    autocomplete="off" />
                </div>
                <div class="col-sm-2">
          ...
          <div class="row">
            ...
            <div class="col-4 col-sm-6 col-12 mt-75">
              <div class="checkbox">
                <input type="checkbox" class="checkbox" name="stoktandus" id="stoktandus" checked>
                <label for="stoktandus" style="color:red">Stoktan Düş/Ekle</label>
              </div>
...
@section('page-scripts')
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $(document).on("click change", ".parca-satir input[type=text]", function() {
