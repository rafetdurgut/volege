      ...
      <div class="form-group row">
        <div class="col-sm-6">
          <div class="form-group row">
            ...
            <div class="input-group col-sm-9">
              ...
              <input type="button" name="odemekoduolustur" id="odemekoduolustur" value="Oluştur"
        ...
        <div class="col-sm-6">
          <div class="form-group row">
            ...
            <div class="input-group col-sm-9">
              <input type="text" class="form-control" name="carikodu" id="carikodu" placeholder="TC/Cari Kod Giriniz"
                required>
...
@section('page-scripts')
  ...
  function otodoldur(){
    ...
    $(document).ready(function() {
        window.onload=otodoldur();
      $('#odemekoduolustur').on('click', function() {
        otodoldur();
      });
    });
